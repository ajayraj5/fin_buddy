...
def check_response_to_outstanding_demand_page(driver, client_name):
    try:
        ...
        client = frappe.get_doc("Income Tax Client", client_name, fields=['username'])
                ...
                try:
                    ...
                    if button_type == "response":
                        ...
                        try:
                            ...
                            # Get the user directory for saving files
                            client = frappe.get_doc("Income Tax Client", username, fields=['username'])
...
def login_into_portal(client_name):
    ...
    if client_name:
        # Get the client doc
        doc = frappe.get_doc("Income Tax Client", client_name)
